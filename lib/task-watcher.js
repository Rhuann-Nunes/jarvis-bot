...
Vencimento: ${formattedDueDate}
  ...
  async sendNotification(phoneNumber, message, taskId) {
    try {
      ...
      // Formatar número para o WhatsApp (adicionar código do país)
      // Se o número já tem 55, não adicionar novamente
      ...
      if (this.client && typeof this.client.sendMessage === 'function') {
        ...
        console.log(`[TASK_WATCHER] Notificação enviada com sucesso para ${formattedNumber}`);
      } else {
